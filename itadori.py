...
st.markdown(
    '# イタドリ '
    '<span style="font-size: 0.35em; font-weight: normal; color: #fff; background-color: #333; padding: 2px 8px; margin-left: 8px; border-radius: 4px;">　Powered by TRUNK TECH ENGINE　</span>',
