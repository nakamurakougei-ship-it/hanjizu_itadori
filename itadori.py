...
st.markdown(
    '# イタドリ '
    '<span style="font-size: 0.45em; font-weight: normal; color: #fff; background-color: #000; padding: 2px 8px; margin-left: 8px; border-radius: 4px;">powered by TrunkTechEngine</span>',
